...
class PlexInputWidget<T> extends StatefulWidget {
  PlexInputWidget({
    ...
    this.useMargin = true,
    this.margin =
        const EdgeInsets.symmetric(horizontal: Dim.medium, vertical: Dim.small),
    this.helperText,
    this.editable = true,
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.type == PlexInputWidgetType.typeInput) {
        ...
        child: Container(
          ...
          child: Padding(
            padding: const EdgeInsets.symmetric(
                horizontal: Dim.small, vertical: Dim.medium),
            child: Row(
              children: [
                Expanded(
                  child: PlexWidget<T?>(
      ...
      inputWidget = Container(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(
              horizontal: Dim.small, vertical: Dim.smallest),
          child: Row(
            children: [
              Expanded(
                child: PlexWidget<T?>(
                      ...
                      onTap: () {
                        ...
                        if(widget.type == PlexInputWidgetType.typeDate) {
                          ...
                          showTimePicker(
                            ...
                            if (value != null) {
                              DateTime dateTime = getDropDownController()
                                  .data as DateTime? ??
                                  DateTime.now();
                              dateTime = DateTime(
                                dateTime.year,
