      ...
      child: Column(
        ...
        children: [
          ExampleCard(
            ...
            child: Text(
              "This page still demonstrates the Gantt widget. Chrome uses the same tokens as the rest of the example. The Review bar shows progress (0.6). Development depends on Design. Tap is wired if you add onTaskTap.",
